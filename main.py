    """
    Anagram Challenge Ncmi2l4e
    ==========================
    Open-source Python game project showcasing how to discover classic mechanics.
    ...
    APP_NAME    = "Anagram Challenge Ncmi2l4e"
    APP_VERSION = "1.0.0"
...
return {"score": score, "rounds": guessed_in, "won": score > 0}
    ...
    def build_parser() -> argparse.ArgumentParser:
        p = argparse.ArgumentParser(prog=APP_NAME, description="Open-source Python game project showcasing how to discover classic mechanics.")
